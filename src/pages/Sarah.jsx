        ...
        <div className="max-w-sm bg-white p-2 grid place-items-center text-center   border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
              ...
              <Modal show={openModalTablet} onClose={() => setOpenModalTablet(false)}>
                ...
                <Modal.Footer>
                  <Button color="gray"  className='mx-auto mb-2' onClick={() => setOpenModalTablet(false)}>
                    Close
                  </Button>
                </Modal.Footer>
              </Modal>
        ...
        <div className="max-w-sm bg-white p-2 grid place-items-center text-center   border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
              ...
              <Modal show={openModalFrames} onClose={() => setOpenModalFrames(false)}>
                ...
                <Modal.Footer>
                  <Button color="gray"  className='mx-auto mb-2' onClick={() => setOpenModalFrames(false)}>
                    Close
                  </Button>
                </Modal.Footer>
              </Modal>
        ...
        <div className="max-w-sm bg-white p-2 grid place-items-center text-center   border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
              ...
              <Modal show={openModalMonday} onClose={() => setOpenModalMonday(false)}>
                ...
                <Modal.Footer>
                  <Button color="gray"  className='mx-auto mb-2' onClick={() => setOpenModalMonday(false)}>
                    Close
                  </Button>
                </Modal.Footer>
              </Modal>
        ...
        <div className="max-w-sm bg-white p-2 grid place-items-center text-center   border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
              ...
              <Modal show={openModalTryon} onClose={() => setOpenModalTryon(false)}>
                ...
                <Modal.Footer>
                  <Button color="gray"  className='mx-auto mb-2' onClick={() => setOpenModalTryon(false)}>
                    Close
                  </Button>
                </Modal.Footer>
              </Modal>
